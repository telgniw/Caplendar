...
$.timepicker=new Timepicker();$.timepicker.version="0.9.4";})(jQuery);
// customized setting
(function($){
$.datepicker.regional['zh_TW'] = { dayNames: ['星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六'], dayNamesShort: ['日', '一', '二', '三', '四', '五', '六'], dayNamesMin: ['日', '一', '二', '三', '四', '五', '六'], monthNames: ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'], monthNamesShort: ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'], currentText: '現在時間', closeText: '完成' };
$.datepicker.setDefaults($.datepicker.regional['zh_TW']);
$.timepicker.regional['zh_TW'] = { timeText: '時間', hourText: '小時', minuteText: '分鐘', secondText: '秒鐘', timeOnlyTitle: '選擇時間', currentText: '現在時間', closeText: '完成' };
